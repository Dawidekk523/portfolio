...
const aboutme = () => {
    return (
        <div className="flex flex-col lg:flex-row lg:justify-center">
            <div className="flex justify-center sm:flex sm:justify-center flex-shrink-0">
                <img className='h-[250px] sm:h-[400px] flex-none flex-shrink-0' src={illustration}/>
            </div>
            ...
            <div className="hireme items-center justify-center flex">
                <button type="button" onClick={buttonFunc} className="text-gray-100 bg-gray-900 hover:bg-gray-700 focus:ring-4 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center drop-shadow-lg">
                Send Message!
